...
opts_knit$set(root.dir="C:/Users/ldzsm2/OneDrive - The University of Nottingham/research/terryPat/")
```
...
```{r warning=FALSE, message=FALSE}
load(file =".\\data_ArmedPeace\\codelist_panel2.RData")

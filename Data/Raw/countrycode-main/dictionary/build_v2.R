...
datasets
datasets <- datasets[datasets != './Data/Raw/countrycode-main/dictionary/data_regex.csv']
datasets <- datasets[datasets != './Data/Raw/countrycode-main/dictionary/data_iso_ret.csv']
datasets <- datasets[datasets != './Data/Raw/countrycode-main/dictionary/data_iso_ret2.csv']

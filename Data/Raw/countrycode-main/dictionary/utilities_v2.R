...
#  setup  #
###########
# install.packages(c("pdftools", "conflicted","assertr"))
library(here)
library(conflicted)
library(janitor)
library(readxl)
...
#############################
custom_dict <- read.csv(paste0(here('Data/Raw/countrycode-main/dictionary','data_regex.csv')), na = '', stringsAsFactors = FALSE) %>%
